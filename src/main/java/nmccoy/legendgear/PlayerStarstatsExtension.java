...
public class PlayerStarstatsExtension implements IExtendedEntityProperties {
	...
	*/
	...
	public PlayerStarstatsExtension(EntityPlayer pla) {
		...
		lastSkyZ = 0;
		player = pla;
		grassEmeraldSupply = LegendGear2.maxEmeraldGrassDropsBanked;
		phoenixAffinity = 0;
	}
	...
	public void saveNBTData(NBTTagCompound compound) {
		...
		data.setInteger("grassEmeraldSupply", grassEmeraldSupply);
		data.setInteger("phoenixAffinity", phoenixAffinity);
	...
	public void loadNBTData(NBTTagCompound compound) {
		...
		grassEmeraldSupply = data.getInteger("grassEmeraldSupply");
		phoenixAffinity = data.getInteger("phoenixAffinity");
