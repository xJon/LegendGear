...
public class SpellItem extends Item {
	...
	protected static double baseCastRange = 7;
	protected static double baseCastRadius = 2f;
	protected static double baseCastTime = 2f;
	protected static double baseCritBonus = 0;
	protected static double baseArcanePower = 3;
	protected static int baseMeleeDamage = 2;
	
	protected static SpellID spellType;
	
	protected static boolean isStaff = false;
	...
	protected static double getBaseCastTime(ItemStack stack)
	{
		return baseCastTime;
	}
	protected static double getBaseCritBonus(ItemStack stack)
	{
		return baseCritBonus;
	}
	protected static double getBasePower(ItemStack stack)
	{
		return baseArcanePower;
	}
	protected static double getBaseRange(ItemStack stack)
	{
		return baseCastRange;
	}
	protected static double getBaseRadius(ItemStack stack)
	{
		return baseCastRadius;
	}
	protected static int getSmackDamage(ItemStack stack)
	{
	...
	public void onPlayerStoppedUsing(ItemStack stack, World world,
		...
		if(ticks >= totalTicks)
		{
			...
			Vec3 castPoint = getRayTargetResult(from, player.getLookVec(), getPlayerCastRange(player), world);
	...
	public static void GenerateSpell(EntityPlayer caster, SpellID id, Vec3 location, double radius, double power, boolean critical)
	{
	...
	public static Vec3 getRayTargetResult(Vec3 from, Vec3 direction, double maxDistance, World world)
	{
		...
		MovingObjectPosition mop = world.rayTraceBlocks(copyFrom, castDestination, false);
		if(mop != null)
		{
	...
	public static float getCastingProgress(ItemStack stack, EntityPlayer player, float subtick)
	{
		return Math.min((player.getItemInUseDuration()+subtick)/getCastingTicks(stack, player), 1);
	}
	
	
	public static int getCastingTicks(ItemStack stack, EntityPlayer player)
	{
