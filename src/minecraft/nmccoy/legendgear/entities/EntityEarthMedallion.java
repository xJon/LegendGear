...
public class EntityEarthMedallion extends EntityThrowable {

	public int iconIndex = 6;

	public EntityEarthMedallion(World par1World, EntityLiving par2EntityLiving) {
	...
	public EntityEarthMedallion(World par1World) {
		super(par1World);
		// TODO Auto-generated constructor stub
	}
	@Override
	protected void onImpact(MovingObjectPosition var1) {
		if(var1.typeOfHit==EnumMovingObjectType.TILE && var1.sideHit == 1);
		{
			if(!worldObj.isRemote)
			{
				worldObj.spawnEntityInWorld(new EntityQuake(worldObj, posX, posY, posZ, getThrower()));
